...
- ⚙️ Provisioned and operate a **highly-available Kubernetes cluster** via Terraform, cutting manual provisioning effort significantly
- 🤖 Designing a **two-track ML anomaly-detection pipeline** (OpenSearch Random Cut Forest + custom PyOD/Isolation Forest) to catch volumetric and per-IP auth anomalies faster
- 🚀 Built CI/CD pipelines that cut manual deployment effort by **30%**
- 🧩 Self-host and operate LLM inference and agent-based automation on Kubernetes for internal tooling
...
<img height="165" src="https://github-readme-stats.vercel.app/api?username=cyraxabir&show_icons=true&theme=github_dark&hide_border=true&count_private=true" />
<img height="165" src="https://github-readme-stats.vercel.app/api/top-langs/?username=cyraxabir&layout=compact&theme=github_dark&hide_border=true" />

<img src="https://github-readme-streak-stats.herokuapp.com/?user=cyraxabir&theme=github-dark&hide_border=true" />
...
| Area | Highlight |
|---|---|
| **Incident Response** | Real-time detection & mitigation of a multi-IP Layer 7 DDoS attack (Cloudflare + Wazuh correlation) |
| **AppSec / VAPT** | Critical CVSS 9.1 auth-bypass finding on a government IDP, responsibly disclosed |
| **Platform Engineering** | Terraform-provisioned HA Kubernetes cluster powering national-scale government workloads |
| **CI/CD** | SonarQube-gated pipelines; ~30% reduction in manual deployment effort |
...
💬 **Let's connect** — always open to discussing platform security, Kubernetes architecture, or AI-driven infra automation.

<img src="https://komarev.com/ghpvc/?username=cyraxabir&style=for-the-badge&color=2EA043" alt="Profile views" />
